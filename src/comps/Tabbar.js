      ...
      <div className="d-flex overflow-hidden" ref={scrollRef}>
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-1" && "bg-success-subtle"
          }`}
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-2" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-2"
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-3" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-3"
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-4" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-4"
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-5" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-5"
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-6" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-6"
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-7" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-7"
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-8" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-8"
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-9" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-9"
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-10" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-10 "
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-11" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-11"
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-12" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-12"
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-13" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-13"
        ...
        <span
          className={`px-3 py-2 d-block text-nowrap ${
            activeTab === "tab-14" && "bg-success-subtle"
          }`}
          style={{ cursor: "pointer" }}
          id="tab-14"
